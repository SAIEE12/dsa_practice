...
# In Python, there are several comparison operators:
# 1. Equal to
# 2. Not equal to
# 3. Greater than
# 4. Less than
...
# Assignment operators are used to assign values to variables. They can also perform arithmetic operations and assign the result to the variable.
# In Python, there are several assignment operators:
# 1. Assignment
# 2. Add and assign
...
# Conditional statements are used to perform different actions based on different conditions. In Python, there are several conditional statements:
# 1. if statement
# 2. if-else statement
